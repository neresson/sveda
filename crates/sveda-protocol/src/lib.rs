...
pub const ACCEPT_SVEDA_STREAM: &str = "application/vnd.sveda.stream+json";
pub const ACCEPT_SSE: &str = "text/event-stream";
pub const HEADER_EMBED_TOKEN: &str = "x-sveda-embed-token";
pub const HEADER_HOST_KEY: &str = "x-sveda-host-key";
pub const HEADER_PROTOCOL: &str = "x-sveda-protocol";
pub const HEADER_PROTOCOL_VERSION: &str = "x-sveda-protocol-version";
pub const HEADER_ACCEL_BUFFERING: &str = "x-accel-buffering";
pub const HEADER_PAGE_CONTEXT: &str = "x-sveda-page-context";
pub const HEADER_CHAT_ID: &str = "x-sveda-chat-id";
pub const HEADER_ADMIN_KEY: &str = "x-sveda-admin-key";
pub const TOKEN_PREFIX: &str = "sveda_embed_";
pub const ADMIN_VISITOR_ID: &str = "sveda-admin";
...
pub struct StreamRequest {
    ...
    #[serde(rename = "toolDecisions", default)]
    pub tool_decisions: Vec<ToolDecision>,
...
pub struct ContractAccept {
    #[serde(rename = "svedaStream")]
    pub sveda_stream: String,
    pub sse: String,
}
...
mod tests {
    ...
    fn protocol_constants_match_sidecar_contract() {
        ...
        assert_eq!(contract.accept.sveda_stream, ACCEPT_SVEDA_STREAM);
    ...
    fn wire_events_round_trip_c2_payloads() {
        let events = [
            ...
            StreamEvent::ToolCall {
                ...
                confirmation: Some("required".into()),
                chat_id: None,
                message_id: None,
                timestamp: None,
            },
